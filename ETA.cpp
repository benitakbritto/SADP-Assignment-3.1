...
class Eta
{
  public:
    ...
    int calculateDistance(Map imapObj, int sindex, int dindex);
    int calculateTime(Map imapObj, int sindex, int dindex);
    void decrementTime(Map imapObj, int source_index, int dest_index);
    void goToStart();
};
 ...
 */
int Eta :: calculateDistance(Map imapObj, int sindex, int dindex)
{
    int distance;
    /*
 ...
 */
int Eta :: calculateTime(Map imapObj, int sindex, int dindex)
{
    /*
 ...
 */
void Eta :: decrementTime(Map imapObj, int source_index, int dest_index)
{
    int time = 0;
