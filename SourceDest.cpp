...
class SourceDest
{
  ...
  public:
    void getSourceDest(Map imapObj);
    bool validateLocation(Map imapObj, string source, string destination);
 ...
 */
void SourceDest :: getSourceDest(Map imapObj)
{
    do
    {
      cout<<"----------------------"<<endl;
 ...
 */
bool SourceDest :: validateLocation(Map imapObj, string source, string destination)
{
  int source_index = -1;
  int dest_index = -1;
    /*
